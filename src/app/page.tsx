...
export default function HomePage() {
  // ✅ RULE 1: Call all hooks at the top level.
  ...
  // ✅ RULE 3: Perform conditional rendering *after* all hooks.
  if (status === 'loading') {
    return (
  ...
  // Main return for an authenticated user on the home page
  return (
    <ChatContainer>
        ...
        {messages.length === 0 ? (
          <div className="flex-1 flex items-center justify-center p-4">
            <div className="text-center max-w-md space-y-4">
              {/* Updated Logo Section with bg-muted for placeholder */}
              ...
              <div>
                ...
                <p className="text-muted-foreground"> {/* Use text-muted-foreground */}
              ...
              <div className="grid grid-cols-1 gap-3 text-sm">
                {/* Info Card 1 */}
                <div className="bg-secondary border border-border rounded-lg p-3 text-left">
                  <p className="font-medium text-primary">📅 Schedule Events</p>
                  <p className="text-foreground">Try: "Schedule a team meeting tomorrow at 2 PM"</p>
                </div>
                {/* Info Card 2 */}
                <div className="bg-secondary border border-border rounded-lg p-3 text-left">
